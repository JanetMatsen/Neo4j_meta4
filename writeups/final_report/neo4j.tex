...
The partial correlation graph for these 83 samples will be represented in Neo4j, which has a user-friendly query language, Cypher. % TODO: cite
...
\begin{figure}[H]
    ...
    \caption{Distribution of \# of species in each connected component for the database corresponding to partial correlation cuttoff = 0.02.}
...
In addition to having an interesting quantity of connected components containing multiple species, this cutoff also corresponds to a reasonable cutoff for multiple hypothesis testing. 
...
\begin{figure}[H]
    ...
    \caption{Distribution of number of different species in the connected components of the database corresponding to cutoff = 0.02.}
    \label{fig:dist0-02}
\end{figure}

As shown in \ref{fig:dist0-02}, about half of the connected components have only genes from one species. 
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[scale=0.55]{../../figures_curated/{161213_heatmap_cutof_0.02}.pdf}
