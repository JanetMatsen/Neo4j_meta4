...
The partial correlation graph for these 83 samples was represented in Neo4j, which has a user-friendly query language, Cypher. % TODO: cite
...
One promising algorithm (\cite{girvan2002community}) finds edges that are least central to communities in the graph and removes them.
